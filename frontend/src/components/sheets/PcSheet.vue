...
<template>
  ...
  >
    <div
      class="bottom-sheet relative w-full max-w-lg sm:max-w-[460px] h-[calc(100dvh-36px)] sm:h-[min(720px,calc(100dvh-48px))] sm:min-h-[580px] max-h-[calc(100dvh-24px)] bg-[#1e2025] rounded-t-[32px] sm:rounded-[36px] flex flex-col justify-between p-5 pt-6 pb-6 overflow-visible shadow-2xl border-t sm:border border-white/[0.06] transition-all duration-500"
      :style="{ backgroundImage: sheetBackgroundStyle }"
    ...
    >
      ...
      <div class="flex items-center justify-between pb-1 shrink-0">
        <div class="flex items-center space-x-3.5">
          ...
          <h2 class="text-xl font-bold text-white tracking-tight leading-tight">デスクトップPC</h2>
        </div>
        <div></div>
      </div>
