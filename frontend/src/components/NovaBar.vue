...
<template>
  <div class="fixed top-0 md:top-auto md:bottom-6 inset-x-0 z-40 flex flex-col items-center pointer-events-none pt-[calc(env(safe-area-inset-top,0px)+0.5rem)] md:pt-0 pb-2.5 md:pb-0 px-3 sm:px-6 bg-[#1c1e23] md:bg-transparent backdrop-blur-xl md:backdrop-blur-none border-b border-white/[0.06] md:border-b-0 shadow-lg md:shadow-none">
